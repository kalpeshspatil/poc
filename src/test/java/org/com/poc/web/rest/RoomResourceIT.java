...
import org.com.poc.repository.RoomRepository;
...
class RoomResourceIT {
    ...
    private static final String DEFAULT_ROOM_TITLE = "AAAAAAAAAA";
    private static final String UPDATED_ROOM_TITLE = "BBBBBBBBBB";
    ...
    public static Room createEntity(EntityManager em) {
        Room room = new Room().roomTitle(DEFAULT_ROOM_TITLE).roomDescription(DEFAULT_ROOM_DESCRIPTION).roomType(DEFAULT_ROOM_TYPE);
        return room;
    }
    ...
    public static Room createUpdatedEntity(EntityManager em) {
        Room room = new Room().roomTitle(UPDATED_ROOM_TITLE).roomDescription(UPDATED_ROOM_DESCRIPTION).roomType(UPDATED_ROOM_TYPE);
        return room;
    }
    ...
    void createRoom() throws Exception {
        ...
        assertThat(testRoom.getRoomTitle()).isEqualTo(DEFAULT_ROOM_TITLE);
    ...
    @Test
    @Transactional
    void checkRoomTitleIsRequired() throws Exception {
        int databaseSizeBeforeTest = roomRepository.findAll().size();
        // set the field null
        room.setRoomTitle(null);
    ...
    void getAllRooms() throws Exception {
        ...
        restRoomMockMvc
            ...
            .andExpect(jsonPath("$.[*].roomTitle").value(hasItem(DEFAULT_ROOM_TITLE)))
    ...
    void getRoom() throws Exception {
        ...
        restRoomMockMvc
            ...
            .andExpect(jsonPath("$.roomTitle").value(DEFAULT_ROOM_TITLE))
    ...
    void putNewRoom() throws Exception {
        ...
        updatedRoom.roomTitle(UPDATED_ROOM_TITLE).roomDescription(UPDATED_ROOM_DESCRIPTION).roomType(UPDATED_ROOM_TYPE);
        ...
        Room testRoom = roomList.get(roomList.size() - 1);
        assertThat(testRoom.getRoomTitle()).isEqualTo(UPDATED_ROOM_TITLE);
    ...
    void partialUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.roomDescription(UPDATED_ROOM_DESCRIPTION).roomType(UPDATED_ROOM_TYPE);
    ...
    void fullUpdateRoomWithPatch() throws Exception {
        ...
        partialUpdatedRoom.roomTitle(UPDATED_ROOM_TITLE).roomDescription(UPDATED_ROOM_DESCRIPTION).roomType(UPDATED_ROOM_TYPE);
